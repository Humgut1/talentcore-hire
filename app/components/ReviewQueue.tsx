...
const REASON: Record<string, string> = {
  ...
  /* 최종 면접 잠금(사용자 요청 4). 코멘트는 이미 저장됐고 판정만 남는다 —
     그래서 "코멘트는 남았습니다"를 함께 말해 준다. */
  'need-debrief': '최종 합격·불합격은 디브리프 미팅 뒤에 처리합니다. 코멘트는 남았습니다.',
  'need-recruiter': '최종 판정은 채용 담당자가 기록합니다. 남기신 코멘트는 저장됐습니다.',
}
